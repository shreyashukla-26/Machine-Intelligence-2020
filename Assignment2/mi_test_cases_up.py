...
for i in range(10):
	...
	for j in range(100):
		...
		correct_answer.pop()
		your_answer = PESU_MI_0124_1307_1733.tri_traversal(cost, heuristic, start_point, goals)
		if(your_answer == correct_answer):
			...
			failed.append([test_num, your_answer, correct_answer])
		test_num += 1
	file.readline()
	print("================================================================")
